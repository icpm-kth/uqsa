...
This repository (<https://github.com/icpm-kth/uqsa>) is a continued
development of the methodology presented in the paper:
...
The original code for that paper can be found at:
