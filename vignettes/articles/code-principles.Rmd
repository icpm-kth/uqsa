...
For the most part we do not define _S3_, or _S4_ objects for this
...
prevent accidental printouts of huge amounts of data and cluttering
the screen.
...
The Likelihood's argument list omits several implicit items:
...
and the simulation results `z` are of course not implicit as they
...
If the likelihood function needs _any_ implicit values, they are
...
function, the user can call the update function and inspect the
result.
