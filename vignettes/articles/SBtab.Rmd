...
All of the following examples are from tab separated text files (originally) but
printed using automatic vertical alignment, with the alignment starting with the second
line. You cannot copy paste them directly into new files 
(there must be tabs separating the words/values).
