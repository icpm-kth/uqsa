...
It is also possible to use ABC for deterministic models, if measurement noise is taken into account. So, if we turn on the
`noise` option of the simulator, we can just use ABC on AKAR4, obtaining
