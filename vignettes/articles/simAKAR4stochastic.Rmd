...
s <- simulator.stoch(experiment = e, model.tab = SBtab, vol = 4e-16, nStochSim = 3, outputFunction=AKAR4_func)
...
plot(e[[1]]$outputTimes, e[[1]]$outputValues$AKAR4pOUT,ylim=c(90,200), ylab="AKAP79",
     xlab="t",
