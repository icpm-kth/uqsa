...
plot(e$outputTimes, y[[expInd]]$output, type="s", ylim=c(0,0.23), col=alpha("blue", .1), ylab = "AKAR4", xlab = "time") # plot the simulated trajectory
...
for(i in subsample_indices){
  ...
  lines(e$outputTimes, y[[expInd]]$output, type="s", col=alpha("blue", .1)) # plot the simulated trajectory
}
