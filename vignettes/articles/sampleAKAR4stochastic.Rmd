...
exp_ind <- 1 # Index of the experiment that we want to plot, with corresponding fitted trajectories
e <- experiments[[1]]
...
for(i in subsample_indices){
  ...
  lines(e$outputTimes, y[[exp_ind]]$output, col="blue") # plot the simulated trajectory
}
