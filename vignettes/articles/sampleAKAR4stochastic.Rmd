---
title: "Sample AKAR4 stochastically"
---
...
Moreover, to simulate the stochastic reactions with the Gillespie algorithm we need to specify the volume of space where the reactions take place and obtain the parameter `Phi` which will be needed for simualtions.
