...
```{r makeObjective}
objectiveFunction <- makeObjectiveSSA(experiments, SBtab, par_names, distance, parMap, Phi, reactions, nStochSim = 3)
```
...
clusterExport(cl, c("objectiveFunction", "Sigma", "startPar", "ns", "delta", "dprior"))
