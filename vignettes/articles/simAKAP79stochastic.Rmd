---
title: "Example - Simulation of a Stochastic Model for the AKAP79 reaction network"
---
...
Function `simulator.stoch` will make a function `s`, which will always simulate the
scenarios described in experiment `e`, but for user supplied parameters.

```{r, sim}
exp_ind <- 7 #index of the experiment to consider
