...
Bayesian uncertainty quantification aims to establish the amount of knowledge we have (or indeed lack) about the possible values of model parameters. Sometimes this is described as our belief in different parameter values. The knowledge or belief is expressed in the
...
**1. Define a prior distribution**
This is done in the same way as for the likelihood based approach described above.
