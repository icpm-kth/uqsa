...
(GSL) to be installed in your system.

The model building part of UQSA (transfering the SBtab network model
to a mathematical model in C or R) also requires that you have a C
compiler (e.g. [gcc](https://gcc.gnu.org)), in addition to the GNU
...
find this location.  These can be installed all at once with the
