...
We do have several examples about MPI usage with this package (see documentation on [Parallel chains with MPI](mpi.Rmd) and Example [UQ on deterministic AKAR4 with MPI](sampleAKAR4mpi.html)). However, if you want to try them, you will need MPI.
