...
The SBtab model has now been loaded into R as `data.frames`, and also converted into an
ODE. The data has been loaded as well. 
...
The `ex` variable holds simulation instructions as a plain R list:
inputs, initial values, measurement times, etc. -- but also the actual data.
