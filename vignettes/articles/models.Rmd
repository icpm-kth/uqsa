...
this will write a file called MODEL.vf (where `MODEL` is taken from
the `Document='MODEL'` attribute in the SBtab files); MODEL.vf encodes the model
as an ODE. This file is compatible with the
