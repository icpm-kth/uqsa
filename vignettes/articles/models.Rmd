...
The following R commands load the SBtab model and data into R as `data.frames`, and convert the model into an ODE.
...
More information on the R commands used in the previous code block, and further instructions on building and simulating your own model can be found in the page ["Build and simulate your own model"](user_model.html).
