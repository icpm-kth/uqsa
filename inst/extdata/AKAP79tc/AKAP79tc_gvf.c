...
int AKAP79tc_vf(double t, const double y_[], double f_[], void *par)
{
	...
	double kb_RiixC__Rii_C=p_[13];
	double AKAPoff_1=p_[14];
	double AKAPoff_3=p_[15];
	double AKAPon_1=p_[16];
	double AKAPon_3=p_[17];
	double kf_C_AKAR4=p_[18];
	double kb_C_AKAR4=p_[19];
	double kcat_AKARp=p_[20];
	double kmOFF=p_[21];
	double kmON=p_[22];
	double KD_T=p_[23];
	double b_AKAP=p_[24];
	...
	double kf_Rii_C_cAMP__RiiP_C_cAMP=kf_Rii_C__RiiP_C;
...
/* column 10 (df/dy_9) */
	...
	jac_[73] = 0; /* [4, 9] */
	jac_[89] = 0; /* [5, 9] */
	jac_[105] = kf_Rii_C__RiiP_C; /* [6, 9] */
	jac_[121] = kb_Rii_cAMPxC__Rii_C_cAMP; /* [7, 9] */
	jac_[137] = kb_Rii_cAMPxC__Rii_C_cAMP; /* [8, 9] */
	jac_[153] = (-kf_Rii_C__RiiP_C)-kb_Rii_cAMPxC__Rii_C_cAMP-kb_Rii_CxcAMP__Rii_C_cAMP; /* [9, 9] */
	jac_[169] = 0; /* [10, 9] */
	jac_[185] = 0; /* [11, 9] */
	jac_[201] = 0; /* [12, 9] */
	jac_[217] = 0; /* [13, 9] */
...
/* column 1 (df/dp_0) */
	...
	jacp_[100] = 0; /* [4, 0] */
	jacp_[125] = Rii_C; /* [5, 0] */
	jacp_[150] = Rii_C_cAMP; /* [6, 0] */
	jacp_[175] = 0; /* [7, 0] */
	jacp_[200] = 0; /* [8, 0] */
	jacp_[225] = -Rii_C_cAMP; /* [9, 0] */
	jacp_[250] = 0; /* [10, 0] */
	jacp_[275] = 0; /* [11, 0] */
	jacp_[300] = 0; /* [12, 0] */
	jacp_[325] = 0; /* [13, 0] */
...
/* column 2 (df/dp_1) */
	jacp_[1] = 0; /* [0, 1] */
	jacp_[26] = KD_T*RiiP_C_cAMP-RiiP_C*cAMP; /* [1, 1] */
	jacp_[51] = 0; /* [2, 1] */
	jacp_[76] = 0; /* [3, 1] */
	jacp_[101] = 0; /* [4, 1] */
	jacp_[126] = KD_T*RiiP_C_cAMP-RiiP_C*cAMP; /* [5, 1] */
	jacp_[151] = RiiP_C*cAMP-KD_T*RiiP_C_cAMP; /* [6, 1] */
	jacp_[176] = 0; /* [7, 1] */
	jacp_[201] = 0; /* [8, 1] */
	jacp_[226] = 0; /* [9, 1] */
	jacp_[251] = 0; /* [10, 1] */
...
/* column 3 (df/dp_2) */
	jacp_[2] = 0; /* [0, 2] */
	jacp_[27] = (RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*kb_RiiPxC__RiiP_C*gsl_pow_2(kf_RiiP_cAMPxC__RiiP_C_cAMP)); /* [1, 2] */
	jacp_[52] = (RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*kb_RiiPxC__RiiP_C*gsl_pow_2(kf_RiiP_cAMPxC__RiiP_C_cAMP)); /* [2, 2] */
	jacp_[77] = 0; /* [3, 2] */
	jacp_[102] = (-(RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*kb_RiiPxC__RiiP_C*gsl_pow_2(kf_RiiP_cAMPxC__RiiP_C_cAMP)))-C*RiiP_cAMP; /* [4, 2] */
	jacp_[127] = 0; /* [5, 2] */
	jacp_[152] = C*RiiP_cAMP; /* [6, 2] */
	jacp_[177] = -C*RiiP_cAMP; /* [7, 2] */
	jacp_[202] = 0; /* [8, 2] */
	jacp_[227] = 0; /* [9, 2] */
	jacp_[252] = 0; /* [10, 2] */
	jacp_[277] = 0; /* [11, 2] */
...
/* column 4 (df/dp_3) */
	jacp_[3] = 0; /* [0, 3] */
	jacp_[28] = -(RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP); /* [1, 3] */
	jacp_[53] = -(RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP); /* [2, 3] */
	jacp_[78] = 0; /* [3, 3] */
	jacp_[103] = (RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP)+RiiP_C_cAMP; /* [4, 3] */
	jacp_[128] = 0; /* [5, 3] */
	jacp_[153] = -RiiP_C_cAMP; /* [6, 3] */
	jacp_[178] = RiiP_C_cAMP; /* [7, 3] */
	jacp_[203] = 0; /* [8, 3] */
	jacp_[228] = 0; /* [9, 3] */
	jacp_[253] = 0; /* [10, 3] */
	jacp_[278] = 0; /* [11, 3] */
...
/* column 5 (df/dp_4) */
	jacp_[4] = 0; /* [0, 4] */
	jacp_[29] = RiiP_cAMP-(RiiP*cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP); /* [1, 4] */
	jacp_[54] = RiiP_cAMP-(RiiP*cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP); /* [2, 4] */
	jacp_[79] = 0; /* [3, 4] */
	jacp_[104] = (RiiP*cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP)-RiiP_cAMP; /* [4, 4] */
	jacp_[129] = 0; /* [5, 4] */
	jacp_[154] = 0; /* [6, 4] */
	jacp_[179] = 0; /* [7, 4] */
	jacp_[204] = 0; /* [8, 4] */
...
/* column 6 (df/dp_5) */
	jacp_[5] = 0; /* [0, 5] */
	jacp_[30] = -(RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP)/(KD_T*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP); /* [1, 5] */
	jacp_[55] = (-(RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP)/(KD_T*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP))-C*RiiP; /* [2, 5] */
	jacp_[80] = 0; /* [3, 5] */
	jacp_[105] = (RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP)/(KD_T*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP); /* [4, 5] */
	jacp_[130] = C*RiiP; /* [5, 5] */
	jacp_[155] = 0; /* [6, 5] */
	jacp_[180] = -C*RiiP; /* [7, 5] */
	jacp_[205] = 0; /* [8, 5] */
	jacp_[230] = 0; /* [9, 5] */
	jacp_[255] = 0; /* [10, 5] */
	jacp_[280] = 0; /* [11, 5] */
...
/* column 7 (df/dp_6) */
	jacp_[6] = 0; /* [0, 6] */
	jacp_[31] = (RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*gsl_pow_2(kb_RiiPxC__RiiP_C)*kf_RiiP_cAMPxC__RiiP_C_cAMP); /* [1, 6] */
	jacp_[56] = (RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*gsl_pow_2(kb_RiiPxC__RiiP_C)*kf_RiiP_cAMPxC__RiiP_C_cAMP)+RiiP_C; /* [2, 6] */
	jacp_[81] = 0; /* [3, 6] */
	jacp_[106] = -(RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(KD_T*gsl_pow_2(kb_RiiPxC__RiiP_C)*kf_RiiP_cAMPxC__RiiP_C_cAMP); /* [4, 6] */
	jacp_[131] = -RiiP_C; /* [5, 6] */
	jacp_[156] = 0; /* [6, 6] */
	jacp_[181] = RiiP_C; /* [7, 6] */
	jacp_[206] = 0; /* [8, 6] */
	jacp_[231] = 0; /* [9, 6] */
	jacp_[256] = 0; /* [10, 6] */
	jacp_[281] = 0; /* [11, 6] */
...
/* column 8 (df/dp_7) */
	...
	jacp_[32] = -Rii*cAMP; /* [1, 7] */
	jacp_[57] = 0; /* [2, 7] */
	jacp_[82] = (C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kb_RiixC__Rii_C*kf_Rii_cAMPxC__Rii_C_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP); /* [3, 7] */
	jacp_[107] = 0; /* [4, 7] */
	jacp_[132] = 0; /* [5, 7] */
	jacp_[157] = 0; /* [6, 7] */
	jacp_[182] = -(C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kb_RiixC__Rii_C*kf_Rii_cAMPxC__Rii_C_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP); /* [7, 7] */
	jacp_[207] = Rii*cAMP; /* [8, 7] */
	jacp_[232] = 0; /* [9, 7] */
	jacp_[257] = 0; /* [10, 7] */
	jacp_[282] = 0; /* [11, 7] */
	jacp_[307] = 0; /* [12, 7] */
...
/* column 9 (df/dp_8) */
	...
	jacp_[33] = Rii_cAMP; /* [1, 8] */
	jacp_[58] = 0; /* [2, 8] */
	jacp_[83] = -(C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kb_RiixC__Rii_C*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*gsl_pow_2(kb_cAMPxRii__Rii_cAMP)*kf_Rii_CxcAMP__Rii_C_cAMP); /* [3, 8] */
	jacp_[108] = 0; /* [4, 8] */
	jacp_[133] = 0; /* [5, 8] */
	jacp_[158] = 0; /* [6, 8] */
	jacp_[183] = (C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kb_RiixC__Rii_C*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*gsl_pow_2(kb_cAMPxRii__Rii_cAMP)*kf_Rii_CxcAMP__Rii_C_cAMP); /* [7, 8] */
	jacp_[208] = -Rii_cAMP; /* [8, 8] */
	jacp_[233] = 0; /* [9, 8] */
	jacp_[258] = 0; /* [10, 8] */
	jacp_[283] = 0; /* [11, 8] */
	jacp_[308] = 0; /* [12, 8] */
...
/* column 10 (df/dp_9) */
	...
	jacp_[34] = -Rii_C*cAMP; /* [1, 9] */
	jacp_[59] = 0; /* [2, 9] */
	jacp_[84] = (-(C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kb_RiixC__Rii_C*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*gsl_pow_2(kf_Rii_CxcAMP__Rii_C_cAMP)))-Rii_C*cAMP; /* [3, 9] */
	jacp_[109] = 0; /* [4, 9] */
	jacp_[134] = 0; /* [5, 9] */
	jacp_[159] = 0; /* [6, 9] */
	jacp_[184] = (C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kb_RiixC__Rii_C*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*gsl_pow_2(kf_Rii_CxcAMP__Rii_C_cAMP)); /* [7, 9] */
	jacp_[209] = 0; /* [8, 9] */
	jacp_[234] = Rii_C*cAMP; /* [9, 9] */
	jacp_[259] = 0; /* [10, 9] */
	jacp_[284] = 0; /* [11, 9] */
	jacp_[309] = 0; /* [12, 9] */
	jacp_[334] = 0; /* [13, 9] */
...
/* column 11 (df/dp_10) */
	...
	jacp_[35] = Rii_C_cAMP; /* [1, 10] */
	jacp_[60] = 0; /* [2, 10] */
	jacp_[85] = (C*Rii*kb_RiixC__Rii_C*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP)+Rii_C_cAMP; /* [3, 10] */
	jacp_[110] = 0; /* [4, 10] */
	jacp_[135] = 0; /* [5, 10] */
	jacp_[160] = 0; /* [6, 10] */
	jacp_[185] = -(C*Rii*kb_RiixC__Rii_C*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP); /* [7, 10] */
	jacp_[210] = 0; /* [8, 10] */
	jacp_[235] = -Rii_C_cAMP; /* [9, 10] */
	jacp_[260] = 0; /* [10, 10] */
	jacp_[285] = 0; /* [11, 10] */
	jacp_[310] = 0; /* [12, 10] */
	jacp_[335] = 0; /* [13, 10] */
...
/* column 12 (df/dp_11) */
	...
	jacp_[36] = 0; /* [1, 11] */
	jacp_[61] = 0; /* [2, 11] */
	jacp_[86] = (C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kb_RiixC__Rii_C*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP); /* [3, 11] */
	jacp_[111] = 0; /* [4, 11] */
	jacp_[136] = 0; /* [5, 11] */
	jacp_[161] = 0; /* [6, 11] */
	jacp_[186] = (-(C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kb_RiixC__Rii_C*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP))-C*Rii_cAMP; /* [7, 11] */
	jacp_[211] = -C*Rii_cAMP; /* [8, 11] */
	jacp_[236] = C*Rii_cAMP; /* [9, 11] */
	jacp_[261] = 0; /* [10, 11] */
	jacp_[286] = 0; /* [11, 11] */
	jacp_[311] = 0; /* [12, 11] */
	jacp_[336] = 0; /* [13, 11] */
...
/* column 13 (df/dp_12) */
	...
	jacp_[37] = 0; /* [1, 12] */
	jacp_[62] = 0; /* [2, 12] */
	jacp_[87] = -(C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kb_RiixC__Rii_C*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(gsl_pow_2(kb_Rii_cAMPxC__Rii_C_cAMP)*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP); /* [3, 12] */
	jacp_[112] = 0; /* [4, 12] */
	jacp_[137] = 0; /* [5, 12] */
	jacp_[162] = 0; /* [6, 12] */
	jacp_[187] = (C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kb_RiixC__Rii_C*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(gsl_pow_2(kb_Rii_cAMPxC__Rii_C_cAMP)*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP)+Rii_C_cAMP; /* [7, 12] */
	jacp_[212] = Rii_C_cAMP; /* [8, 12] */
	jacp_[237] = -Rii_C_cAMP; /* [9, 12] */
	jacp_[262] = 0; /* [10, 12] */
	jacp_[287] = 0; /* [11, 12] */
	jacp_[312] = 0; /* [12, 12] */
	jacp_[337] = 0; /* [13, 12] */
	...
	jacp_[387] = 0; /* [15, 12] */
/* column 14 (df/dp_13) */
	jacp_[13] = Rii_C-(C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP); /* [0, 13] */
	jacp_[38] = 0; /* [1, 13] */
	jacp_[63] = 0; /* [2, 13] */
	jacp_[88] = (C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP)-Rii_C; /* [3, 13] */
	jacp_[113] = 0; /* [4, 13] */
	jacp_[138] = 0; /* [5, 13] */
	jacp_[163] = 0; /* [6, 13] */
	jacp_[188] = Rii_C-(C*Rii*kb_Rii_CxcAMP__Rii_C_cAMP*kf_Rii_cAMPxC__Rii_C_cAMP*kf_cAMPxRii__Rii_cAMP)/(kb_Rii_cAMPxC__Rii_C_cAMP*kb_cAMPxRii__Rii_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP); /* [7, 13] */
	jacp_[213] = 0; /* [8, 13] */
	jacp_[238] = 0; /* [9, 13] */
	jacp_[263] = 0; /* [10, 13] */
	jacp_[288] = 0; /* [11, 13] */
	...
	jacp_[388] = 0; /* [15, 13] */
/* column 15 (df/dp_14) */
	jacp_[14] = RiiP_CaN*(1-b_AKAP); /* [0, 14] */
	jacp_[39] = 0; /* [1, 14] */
	jacp_[64] = -CaN*RiiP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF); /* [2, 14] */
	jacp_[89] = 0; /* [3, 14] */
	jacp_[114] = -CaN*RiiP_cAMP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF); /* [4, 14] */
	jacp_[139] = 0; /* [5, 14] */
	jacp_[164] = 0; /* [6, 14] */
	jacp_[189] = 0; /* [7, 14] */
	jacp_[214] = RiiP_cAMP_CaN*(1-b_AKAP); /* [8, 14] */
	jacp_[239] = 0; /* [9, 14] */
	jacp_[264] = (-CaN*RiiP_cAMP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF))-CaN*RiiP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF)+RiiP_cAMP_CaN*(1-b_AKAP)+RiiP_CaN*(1-b_AKAP); /* [10, 14] */
	jacp_[289] = CaN*RiiP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF)-RiiP_CaN*(1-b_AKAP); /* [11, 14] */
	jacp_[314] = CaN*RiiP_cAMP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF)-RiiP_cAMP_CaN*(1-b_AKAP); /* [12, 14] */
	jacp_[339] = 0; /* [13, 14] */
	jacp_[364] = 0; /* [14, 14] */
	jacp_[389] = 0; /* [15, 14] */
/* column 16 (df/dp_15) */
	jacp_[15] = 0; /* [0, 15] */
	jacp_[40] = 0; /* [1, 15] */
	jacp_[65] = RiiP_CaN*(1-b_AKAP)-CaN*RiiP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF); /* [2, 15] */
	jacp_[90] = 0; /* [3, 15] */
	jacp_[115] = RiiP_cAMP_CaN*(1-b_AKAP)-CaN*RiiP_cAMP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF); /* [4, 15] */
	jacp_[140] = 0; /* [5, 15] */
	jacp_[165] = 0; /* [6, 15] */
	jacp_[190] = 0; /* [7, 15] */
	jacp_[215] = 0; /* [8, 15] */
	jacp_[240] = 0; /* [9, 15] */
	jacp_[265] = (-CaN*RiiP_cAMP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF))-CaN*RiiP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF)+RiiP_cAMP_CaN*(1-b_AKAP)+RiiP_CaN*(1-b_AKAP); /* [10, 15] */
	jacp_[290] = CaN*RiiP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF)-RiiP_CaN*(1-b_AKAP); /* [11, 15] */
	jacp_[315] = CaN*RiiP_cAMP*(((1-b_AKAP)*b_AKAP)/kmON+gsl_pow_2(1-b_AKAP)/kmOFF)-RiiP_cAMP_CaN*(1-b_AKAP); /* [12, 15] */
	jacp_[340] = 0; /* [13, 15] */
	jacp_[365] = 0; /* [14, 15] */
	jacp_[390] = 0; /* [15, 15] */
/* column 17 (df/dp_16) */
	jacp_[16] = RiiP_CaN*b_AKAP; /* [0, 16] */
	jacp_[41] = 0; /* [1, 16] */
	jacp_[66] = -CaN*RiiP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF); /* [2, 16] */
	jacp_[91] = 0; /* [3, 16] */
	jacp_[116] = -CaN*RiiP_cAMP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF); /* [4, 16] */
	jacp_[141] = 0; /* [5, 16] */
	jacp_[166] = 0; /* [6, 16] */
	jacp_[191] = 0; /* [7, 16] */
	jacp_[216] = RiiP_cAMP_CaN*b_AKAP; /* [8, 16] */
	jacp_[241] = 0; /* [9, 16] */
	jacp_[266] = (-CaN*RiiP_cAMP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF))-CaN*RiiP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)+RiiP_cAMP_CaN*b_AKAP+RiiP_CaN*b_AKAP; /* [10, 16] */
	jacp_[291] = CaN*RiiP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)-RiiP_CaN*b_AKAP; /* [11, 16] */
	jacp_[316] = CaN*RiiP_cAMP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)-RiiP_cAMP_CaN*b_AKAP; /* [12, 16] */
	jacp_[341] = 0; /* [13, 16] */
	jacp_[366] = 0; /* [14, 16] */
	jacp_[391] = 0; /* [15, 16] */
/* column 18 (df/dp_17) */
	jacp_[17] = 0; /* [0, 17] */
	jacp_[42] = 0; /* [1, 17] */
	jacp_[67] = RiiP_CaN*b_AKAP-CaN*RiiP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF); /* [2, 17] */
	jacp_[92] = 0; /* [3, 17] */
	jacp_[117] = RiiP_cAMP_CaN*b_AKAP-CaN*RiiP_cAMP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF); /* [4, 17] */
	jacp_[142] = 0; /* [5, 17] */
	jacp_[167] = 0; /* [6, 17] */
	jacp_[192] = 0; /* [7, 17] */
	jacp_[217] = 0; /* [8, 17] */
	jacp_[242] = 0; /* [9, 17] */
	jacp_[267] = (-CaN*RiiP_cAMP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF))-CaN*RiiP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)+RiiP_cAMP_CaN*b_AKAP+RiiP_CaN*b_AKAP; /* [10, 17] */
	jacp_[292] = CaN*RiiP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)-RiiP_CaN*b_AKAP; /* [11, 17] */
	jacp_[317] = CaN*RiiP_cAMP*(gsl_pow_2(b_AKAP)/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)-RiiP_cAMP_CaN*b_AKAP; /* [12, 17] */
	jacp_[342] = 0; /* [13, 17] */
	jacp_[367] = 0; /* [14, 17] */
	jacp_[392] = 0; /* [15, 17] */
/* column 19 (df/dp_18) */
	...
	jacp_[143] = 0; /* [5, 18] */
	jacp_[168] = 0; /* [6, 18] */
	jacp_[193] = -AKAR4*C; /* [7, 18] */
	jacp_[218] = 0; /* [8, 18] */
	jacp_[243] = 0; /* [9, 18] */
	jacp_[268] = 0; /* [10, 18] */
	jacp_[293] = 0; /* [11, 18] */
	jacp_[318] = 0; /* [12, 18] */
	jacp_[343] = -AKAR4*C; /* [13, 18] */
	jacp_[368] = AKAR4*C; /* [14, 18] */
	jacp_[393] = 0; /* [15, 18] */
/* column 20 (df/dp_19) */
	jacp_[19] = 0; /* [0, 19] */
	jacp_[44] = 0; /* [1, 19] */
	...
	jacp_[144] = 0; /* [5, 19] */
	jacp_[169] = 0; /* [6, 19] */
	jacp_[194] = AKAR4_C; /* [7, 19] */
	jacp_[219] = 0; /* [8, 19] */
	jacp_[244] = 0; /* [9, 19] */
	jacp_[269] = 0; /* [10, 19] */
	jacp_[294] = 0; /* [11, 19] */
	jacp_[319] = 0; /* [12, 19] */
	jacp_[344] = AKAR4_C; /* [13, 19] */
	jacp_[369] = -AKAR4_C; /* [14, 19] */
	jacp_[394] = 0; /* [15, 19] */
/* column 21 (df/dp_20) */
	jacp_[20] = 0; /* [0, 20] */
	jacp_[45] = 0; /* [1, 20] */
	...
	jacp_[320] = 0; /* [12, 20] */
	jacp_[345] = 0; /* [13, 20] */
	jacp_[370] = -AKAR4_C; /* [14, 20] */
	jacp_[395] = AKAR4_C; /* [15, 20] */
/* column 22 (df/dp_21) */
	jacp_[21] = 0; /* [0, 21] */
	jacp_[46] = 0; /* [1, 21] */
	jacp_[71] = (CaN*RiiP*(1-b_AKAP)*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmOFF); /* [2, 21] */
	jacp_[96] = 0; /* [3, 21] */
	jacp_[121] = (CaN*RiiP_cAMP*(1-b_AKAP)*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmOFF); /* [4, 21] */
	jacp_[146] = 0; /* [5, 21] */
	jacp_[171] = 0; /* [6, 21] */
	jacp_[196] = 0; /* [7, 21] */
	jacp_[221] = 0; /* [8, 21] */
	jacp_[246] = 0; /* [9, 21] */
	jacp_[271] = (CaN*RiiP_cAMP*(1-b_AKAP)*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmOFF)+(CaN*RiiP*(1-b_AKAP)*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmOFF); /* [10, 21] */
	jacp_[296] = -(CaN*RiiP*(1-b_AKAP)*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmOFF); /* [11, 21] */
	jacp_[321] = -(CaN*RiiP_cAMP*(1-b_AKAP)*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmOFF); /* [12, 21] */
	jacp_[346] = 0; /* [13, 21] */
	jacp_[371] = 0; /* [14, 21] */
	jacp_[396] = 0; /* [15, 21] */
/* column 23 (df/dp_22) */
	jacp_[22] = 0; /* [0, 22] */
	jacp_[47] = 0; /* [1, 22] */
	jacp_[72] = (CaN*RiiP*b_AKAP*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmON); /* [2, 22] */
	jacp_[97] = 0; /* [3, 22] */
	jacp_[122] = (CaN*RiiP_cAMP*b_AKAP*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmON); /* [4, 22] */
	jacp_[147] = 0; /* [5, 22] */
	jacp_[172] = 0; /* [6, 22] */
	jacp_[197] = 0; /* [7, 22] */
	jacp_[222] = 0; /* [8, 22] */
	jacp_[247] = 0; /* [9, 22] */
	jacp_[272] = (CaN*RiiP_cAMP*b_AKAP*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmON)+(CaN*RiiP*b_AKAP*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmON); /* [10, 22] */
	jacp_[297] = -(CaN*RiiP*b_AKAP*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmON); /* [11, 22] */
	jacp_[322] = -(CaN*RiiP_cAMP*b_AKAP*(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP)))/gsl_pow_2(kmON); /* [12, 22] */
	jacp_[347] = 0; /* [13, 22] */
	jacp_[372] = 0; /* [14, 22] */
	jacp_[397] = 0; /* [15, 22] */
/* column 24 (df/dp_23) */
	jacp_[23] = 0; /* [0, 23] */
	jacp_[48] = (RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(gsl_pow_2(KD_T)*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP)+RiiP_C_cAMP*kf_RiiP_CxcAMP__RiiP_C_cAMP; /* [1, 23] */
	jacp_[73] = (RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(gsl_pow_2(KD_T)*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP); /* [2, 23] */
	jacp_[98] = 0; /* [3, 23] */
	jacp_[123] = -(RiiP*cAMP*kb_RiiPXcAMP__RiiP_cAMP*kb_RiiP_cAMPxC__RiiP_C_cAMP*kf_RiiPxC__RiiP_C)/(gsl_pow_2(KD_T)*kb_RiiPxC__RiiP_C*kf_RiiP_cAMPxC__RiiP_C_cAMP); /* [4, 23] */
	jacp_[148] = RiiP_C_cAMP*kf_RiiP_CxcAMP__RiiP_C_cAMP; /* [5, 23] */
	jacp_[173] = -RiiP_C_cAMP*kf_RiiP_CxcAMP__RiiP_C_cAMP; /* [6, 23] */
	jacp_[198] = 0; /* [7, 23] */
	jacp_[223] = 0; /* [8, 23] */
	jacp_[248] = 0; /* [9, 23] */
	jacp_[273] = 0; /* [10, 23] */
	...
	jacp_[398] = 0; /* [15, 23] */
/* column 25 (df/dp_24) */
	jacp_[24] = (AKAPon_1-AKAPoff_1)*RiiP_CaN; /* [0, 24] */
	jacp_[49] = 0; /* [1, 24] */
	jacp_[74] = (AKAPon_3-AKAPoff_3)*RiiP_CaN-CaN*RiiP*((AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmON+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*b_AKAP)/kmON-(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmOFF+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*(1-b_AKAP))/kmOFF); /* [2, 24] */
	jacp_[99] = 0; /* [3, 24] */
	jacp_[124] = (AKAPon_3-AKAPoff_3)*RiiP_cAMP_CaN-CaN*RiiP_cAMP*((AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmON+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*b_AKAP)/kmON-(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmOFF+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*(1-b_AKAP))/kmOFF); /* [4, 24] */
	jacp_[149] = 0; /* [5, 24] */
	jacp_[174] = 0; /* [6, 24] */
	jacp_[199] = 0; /* [7, 24] */
	jacp_[224] = (AKAPon_1-AKAPoff_1)*RiiP_cAMP_CaN; /* [8, 24] */
	jacp_[249] = 0; /* [9, 24] */
	jacp_[274] = (-CaN*RiiP_cAMP*((AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmON+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*b_AKAP)/kmON-(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmOFF+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*(1-b_AKAP))/kmOFF))-CaN*RiiP*((AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmON+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*b_AKAP)/kmON-(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmOFF+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*(1-b_AKAP))/kmOFF)+(AKAPon_3-AKAPoff_3)*RiiP_cAMP_CaN+(AKAPon_1-AKAPoff_1)*RiiP_cAMP_CaN+(AKAPon_3-AKAPoff_3)*RiiP_CaN+(AKAPon_1-AKAPoff_1)*RiiP_CaN; /* [10, 24] */
	jacp_[299] = CaN*RiiP*((AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmON+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*b_AKAP)/kmON-(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmOFF+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*(1-b_AKAP))/kmOFF)-(AKAPon_3-AKAPoff_3)*RiiP_CaN-(AKAPon_1-AKAPoff_1)*RiiP_CaN; /* [11, 24] */
	jacp_[324] = CaN*RiiP_cAMP*((AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmON+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*b_AKAP)/kmON-(AKAPon_3*b_AKAP+AKAPon_1*b_AKAP+AKAPoff_3*(1-b_AKAP)+AKAPoff_1*(1-b_AKAP))/kmOFF+((AKAPon_3+AKAPon_1-AKAPoff_3-AKAPoff_1)*(1-b_AKAP))/kmOFF)-(AKAPon_3-AKAPoff_3)*RiiP_cAMP_CaN-(AKAPon_1-AKAPoff_1)*RiiP_cAMP_CaN; /* [12, 24] */
	jacp_[349] = 0; /* [13, 24] */
	jacp_[374] = 0; /* [14, 24] */
	jacp_[399] = 0; /* [15, 24] */
	return GSL_SUCCESS;
